...
# -*- coding: utf-8 -*-
#
# rosette documentation build configuration file, created by
...
def build_and_add_path():
    ...
    print('sphinx conf.py: rebuilding rosette module for py' + version)
    if on_rtd:
        assert sys.executable.startswith(
            '/home/docs/checkouts/readthedocs.org/user_builds/rosette/conda')
    ...
    print('=' * 20, 'sphinx conf.py BUILDING', '=' * 20)
    sys.stdout.flush()
    ...
    if True:
        assert not os.system('(cd .. && python' + version +
                             ...
                             '--local_setup_opts_build_args=_rosette )')
        rosettepath = os.path.abspath(
            glob.glob('../build_docs/lib.*' + version + '*')[0])
        print('sphinx conf.py adding to sys.path:',
              os.path.abspath(rosettepath))
        sys.path.insert(0, rosettepath)
        import rosette
        print("sphinx conf.py imported rosette successfully")
        print('=' * 20, 'sphinx conf.py DONE BUILDING', '=' * 20)
        # break
        # except:
...
breathe_projects = {
    '_rosette': '.build/doxygenxml'
}
breathe_default_project = '_rosette'
...
latex_documents = [
    (master_doc, 'rosette.tex', 'rosette Documentation',
     'Will Sheffler', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
# latex_logo = 'rosette-logo.png'
...
man_pages = [
    (master_doc, 'rosette', 'rosette Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rosette', 'rosette Documentation',
     author, 'rosette', 'One line description of project.',
     'Miscellaneous'),
]
